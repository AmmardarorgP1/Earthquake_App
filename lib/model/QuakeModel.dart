import 'package:quake_app/utils/DataHelperFunction.dart';
...
class Properties {
  ...
  Properties.fromJson(Map<String, dynamic> json) {
    ...
    if(cdi == null)
      ...
      {
        cdi = DataHelper.toDouble(json["cdi"]);
      }
    mmi ;
    if(mmi == null )
      {
      ...
      {
        mmi = DataHelper.toDouble(json['mmi']);
      }
    alert = json['alert'];
    status = json['status'];
    ...
    if(dmin == null )
      ...
      {
        dmin = DataHelper.toDouble(json['dmin']);
      }
    rms = DataHelper.toDouble(json['rms']);
    gap ;
    if(gap == null)
      {
        gap ;
